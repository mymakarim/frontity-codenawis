...
const SharingButtons = ({link, title}) => {
    return (
        <SharingButton>
            <a target="_blank" href={`http://www.facebook.com/share.php?u=${link}&amp;title=${title}`}>
            ...
            <a target="_blank" href={`http://twitter.com/share?text=${title}&amp;url=${link}`}>
            ...
            <a target="_blank" href={`http://www.linkedin.com/shareArticle?mini=true&amp;url=${link}&amp;title=${title}&amp;source=${link}`}>
